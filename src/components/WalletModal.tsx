...
interface WalletModalProps {
  open: boolean;
  onClose: () => void;
  onSave: (wallet: { name: string; initialBalance: number; color: string }) => void;
}

const colorOptions = [
  { value: 'bg-rupi-accent', label: 'Green' },
...
export function WalletModal({ open, onClose, onSave }: WalletModalProps) {
  ...
  const handleSave = () => {
    ...
    onSave({ name, initialBalance: balance, color });
