...
import { Home, Wallet, ArrowDownLeft, ArrowUpRight, Settings, List } from 'lucide-react';
...
export function Sidebar() {
  ...
  return <aside className="w-64 bg-card border-r border-border overflow-y-auto no-scrollbar">
      <div className="p-4">
        <h2 className="text-xl font-bold flex items-center gap-2 text-primary mb-6">
          ...
          <span className="text-emerald-500">DuitNow</span>
        </h2>
      </div>
